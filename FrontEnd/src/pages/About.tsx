...
import {
   slideFromLeftAnimationVariants,
   textAnimationVariants,
} from "../static/variants";
      ...
      <article className="h-full w-full">
         <section className="bg-family h-screen w-full bg-center bg-cover relative">
            ...
            >
               ...
               Lorem Ipsum
               <br />
               <div className="text-[#262626] leading-tight text-[0.5em]">
                  something
               </div>
               <button
         ...
         <section className="bg-pacific-blue from-10% bg-gradient-to-t from-[#19182f42] h-full w-full bg-center bg-cover relative py-12 justify-center items-center">
            ...
            <div className="flex flex-col gap-6 w-full h-full justify-center items-center text-pacific-light-gray cursor-default self-center">
               <motion.div
                  className="rounded border-2 border-pacific-light-blue px-4 py-6 w-[60%] md:w-[50%] text-center transition ease-in-out hover:bg-pacific-light-gray hover:text-pacific-blue"
                  initial="initial"
                  whileInView="animate"
                  exit="exit"
                  viewport={{ once: true }}
         ...
         <footer className="grid justify-center grid-cols-4 gap-x-6 bg-[#262626] px-[20%] min-h-[10vh] h-full py-8 text-pacific-gray text-sm cursor-default">
            <div className="flex flex-col text-left gap-1 col-span-2">
               Maybe our team logo
            </div>
