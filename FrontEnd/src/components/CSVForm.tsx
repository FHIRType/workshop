...
const Modal = ({ isOpen, onClose, csvFileName, setCsvFileName, handleDrop, value }) => {
    ...
    return (
        <div
            ...
            <div
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg p-8 w-[80%] h-[80%]"
                ...
                <div className="mt-4 flex flex-col items-center">
                    {csvFileName ? (
                        ...
                        <div className="flex">
                            ...
                            <button className="px-1 py-1 mr-5 w-[calc(5vw+2em)] bg-pacific-blue text-white min-w-[50px] transition ease-in-out">
                                Data Format
                            </button>
                            <button className="px-1 py-1 w-[calc(5vw+2em)] bg-pacific-blue text-white min-w-[50px] transition ease-in-out">
                                CSV
                            </button>
                        </div>
                    )}
                    <button onClick={openFileBrowser} className="bg-blue-500 text-white px-4 py-2 rounded mt-4 mr-2">
                        Upload File
                    </button>
                    ...
                    {fileContent && (
                        <>
                            ...
                            <textarea
                                value={fileContent}
                                readOnly
                                className="w-full h-32 mt-2 px-4 py-2 border border-gray-300 rounded resize-none"
                            />
                            <button onClick={removeFile} className="bg-red-500 text-white px-4 py-2 rounded mt-2">
                                Remove File
                            </button>
    ...
    return (
        <div className="w-full h-full flex items-center justify-center">
            <div className="bg-white border-1 border-pacific-gray flex flex-col p-10 rounded-lg gap-2 w-[80vw]">
                <div
                    className="cursor-pointer hover:bg-pacific-light-gray transition ease-in-out p-8 flex flex-col justify-center items-center"
